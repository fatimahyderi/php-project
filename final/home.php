	...
	<div id="header">
		<div class="head-view">
			<ul>
				...
				<li><a href="add_friend.php" title="Settings"><label>Add Friends</label></a></li>
...
?>
		 ...
		 <form  method="POST" action="comment.php">			
			<div class="comment-area">
						...
						<?php 
						include 'connect.php';
						$image=mysqli_query($conn,"select * from user where user_id='$id'");//or die(mysql_error());
